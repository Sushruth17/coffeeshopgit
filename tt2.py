...
class CustomGoogleMapPlotter(GoogleMapPlotter):
    def __init__(self, center_lat, center_lng, zoom, apikey='AIzaSyBuHC_G8d3kvYYAFE5uk85hA7eyOOs0jVs',
                 map_type='satellite'):
        if apikey == 'AIzaSyBuHC_G8d3kvYYAFE5uk85hA7eyOOs0jVs':
            try:
                with open('apikey.txt', 'r') as apifile:
                    apikey = apifile.readline()
            except FileNotFoundError:
                pass
        super().__init__(center_lat, center_lng, zoom)
...
gmap.draw("C:\\Users\\admin\\\Desktop\\ttttttttmap.html")